...
DECLARE
  ...
  v_emp_mgr_id hr_base.widget_emp_base.emp_mgr_id%TYPE := 90001;  -- Replace with a valid manager ID
  ...
  v_emp_dept_id hr_base.widget_emp_base.emp_dept_id%TYPE := 2;  -- Replace with a valid department ID
BEGIN
...
DECLARE
  v_emp_id hr_base.widget_emp_base.emp_id%TYPE := 90011;  -- Replace with a valid employee ID
  v_new_dept_id hr_base.widget_emp_base.emp_dept_id%TYPE := 3;  -- Replace with a valid new department ID
BEGIN
